...
(function (Charjs) {
    var GameMaster = (function () {
        ...
        GameMaster.GetController = function (gameName, targetDom, charSize, frameInterval, goolCallback, gameoverCallback) {
        ...
        GameMaster.prototype.CreatePlayerInstance = function (clz, position, direction, name) {
        ...
        GameMaster.prototype.getApproachedObjects = function (target, radius) {
            ...
            for (var name_1 in this._objects) {
                if (this._objects[name_1].isActive()) {
                    var objPos = this._objects[name_1].getPosition();
                    ...
                    if (charPos.x - radius < objPos.x && objPos.x < charPos.x + radius &&
                        ...
                        objs.push(this._objects[name_1]);
                    }
                }
            }
            for (var name_2 in this._players) {
                if (target != this._players[name_2]) {
                    objs.push(this._players[name_2]);
                }
            }
            return objs;
        };
        GameMaster.prototype.cleanEntityEnemiesFromAllObjects = function (target) {
            if (target instanceof Charjs.AbstractEnemy) {
                for (var name_3 in this._objects) {
                    if (this._objects[name_3] instanceof Charjs.AbstractOtherObject) {
        ...
        GameMaster.prototype.init = function () {
            for (var name_4 in this._players) {
                this._players[name_4].init(true);
            }
            ...
            for (var name_8 in this._players) {
                this._players[name_8].start();
            }
        ...
        GameMaster.prototype.doGameOver = function (player) {
        ...
        GameMaster.prototype.doGool = function (player) {
            var _this = this;
                        ...
                        var goolDimOffTimer = _this.addEvent(function () {
                            if (backgroundOpacity.toFixed(2) != "0.20") {
                                ...
                                var circleTimer_1 = _this.addEvent(function () {
                                    circleSize_1 -= 20;
                                    var rect = player.getCurrntElement().getBoundingClientRect();
                                    _this.drawBlackClipCircle(screen, rect, circleSize_1, circleAnimationCount_1, player.zIndex + 1);
        ...
        GameMaster.prototype.drawBlackClipCircle = function (targetDom, rect, size, count, zIndex) {
...
var Charjs;
(function (Charjs) {
    var AbstractGamePeer = (function (_super) {
        __extends(AbstractGamePeer, _super);
        function AbstractGamePeer() {
        ...
        return AbstractGamePeer;
    }(Charjs.GameMaster));
    AbstractGamePeer.INIT_COMMAND = "initGame";
    AbstractGamePeer.START_COMMAND = "start";
    AbstractGamePeer.CREATE_PLAYER_COMMAND = "createPlayer";
    AbstractGamePeer.CREATE_ENEMY_COMMAND = "createEnemy";
    AbstractGamePeer.CREATE_OBJECT_COMMAND = "createObject";
    AbstractGamePeer.CLIENT_INIT_DONE_COMMAND = "clientInitDone";
    AbstractGamePeer.HOST_INIT_DONE_COMMAND = "hostInitDone";
    AbstractGamePeer.CONNECTED_COMMAND = "connectSuccess";
    Charjs.AbstractGamePeer = AbstractGamePeer;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
...
(function (Charjs) {
    var AbstractObject = (function (_super) {
        ...
        function AbstractObject(targetDom, pixSize, position, _direction, useLeft, useVertical, zIndex, frameInterval) {
            ...
            if (_direction === void 0) { _direction = Charjs.Direction.Right; }
        ...
        AbstractObject.prototype.createCharacterAction = function (charactorMap, shadow, isReverse, isVerticalRotation) {
            ...
            Charjs.AbstractCharacter.drawCharacter(element.getContext('2d'), charactorMap, this.colors, this.pixSize, isReverse, isVerticalRotation, shadow);
            return element;
        };
        ...
        AbstractObject.prototype.draw = function (index, position, direction, vertical, removeCurrent, drawOffset, clone) {
            ...
            if (direction === void 0) { direction = Charjs.Direction.Right; }
            if (vertical === void 0) { vertical = Charjs.Vertical.Up; }
            ...
            var action = null;
            if (vertical == Charjs.Vertical.Up) {
                action = direction == Charjs.Direction.Right ? this._rightActions[index] : this._leftActions[index];
            }
            else {
                action = direction == Charjs.Direction.Right ? this._verticalRightActions[index] : this._verticalLeftActions[index];
            }
            if (clone) {
        ...
        AbstractObject.prototype.cloneCanvas = function (oldCanvas) {
            var canvas = Charjs.AbstractPixel.createCanvasElement(oldCanvas.width, oldCanvas.height, this.zIndex + 1);
        ...
        AbstractObject.prototype.getDirection = function () {
            return this._direction;
        };
        AbstractObject.prototype.isActive = function () {
...
(function (Charjs) {
    var AbstractCharacter = (function (_super) {
        ...
        AbstractCharacter.prototype.destroy = function () {
            this.stop();
            if (this._gameMaster && this instanceof Charjs.AbstractEnemy) {
                ...
                for (var _i = 0, objs_1 = objs; _i < objs_1.length; _i++) {
                    ...
                    if (cPosLeft >= oPosLeft && cPosLeft <= oPosRight || cPosRight >= oPosLeft && cPosRight <= oPosRight) {
                        if (cPosUnder >= oPosUpper && (this.entity.ground === null || this.entity.ground <= oPosUpper)) {
                            ...
                            if (obj instanceof Charjs.AbstractOtherObject) {
                                if (cPosUnder == oPosUpper && this instanceof Charjs.AbstractEnemy && obj.entityEnemies.indexOf(this) == -1)
        ...
        AbstractCharacter.prototype.updateDirection = function () {
            ...
            if (this.position.x + this.size.width >= right && currentDirection == Charjs.Direction.Right) {
                this._direction = Charjs.Direction.Left;
            }
            if (this.position.x <= left && currentDirection == Charjs.Direction.Left) {
...
(function (Charjs) {
    var GamepadController = (function () {
        function GamepadController(_padIndex, _keyAssign, scanInterval) {
            if (_padIndex === void 0) { _padIndex = 0; }
            if (_keyAssign === void 0) { _keyAssign = GamepadController.DefaultKeyAssign; }
            if (scanInterval === void 0) { scanInterval = 45; }
            this._padIndex = _padIndex;
            this._keyAssign = _keyAssign;
            this.scanInterval = scanInterval;
            this._gamepadTimer = null;
            this._player = null;
            this._isPausePressed = false;
        }
        GamepadController.prototype.init = function (player) {
            this._player = player;
            this._player.setController(this);
            return this;
        };
        GamepadController.isGamepadConnected = function (index) {
        ...
        GamepadController.prototype.scangamepads = function () {
            ...
            if (gamepads[this._padIndex]) {
                this._gamepadTimer = setInterval(function () { _this.updatePadStatus(); }, this.scanInterval);
            }
        };
        GamepadController.prototype.updatePadStatus = function () {
            var gamepads = navigator.getGamepads ? navigator.getGamepads() : (navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : []);
            var gamepad = gamepads[this._padIndex];
        ...
        GamepadController.prototype.destroyCommand = function () {
            if (this._gamepadTimer)
                clearInterval(this._gamepadTimer);
        };
        GamepadController.prototype.registerCommand = function () {
            var _this = this;
            var gamepads = navigator.getGamepads ? navigator.getGamepads() : (navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : []);
    ...
    GamepadController.DefaultKeyAssign = {
        left: 14,
        right: 15,
        up: 12,
        down: 13,
    ...
    Charjs.GamepadController = GamepadController;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var KeyboardController = (function () {
        function KeyboardController(_keyAssign) {
            if (_keyAssign === void 0) { _keyAssign = KeyboardController.DefaultKeyAssign; }
            this._keyAssign = _keyAssign;
        }
        KeyboardController.prototype.init = function (player, keyPattern) {
            this._player = player;
            this._player.setController(this);
            return this;
        };
        KeyboardController.prototype.destroyCommand = function () {
        };
        KeyboardController.prototype.registerCommand = function () {
            var _this = this;
            document.addEventListener('keydown', function (e) {
                if (e.keyCode == _this._keyAssign.a) {
                    _this._player.onJump();
                }
                if (e.keyCode == _this._keyAssign.x || e.keyCode == _this._keyAssign.y) {
                    _this._player.onSpecialJump();
                }
                if (e.keyCode == _this._keyAssign.b) {
                    _this._player.onSpeedUp();
                    _this._player.onGrab();
                }
                if (e.keyCode == _this._keyAssign.up) {
                    _this._player.onLookup();
                }
                if (e.keyCode == _this._keyAssign.down) {
                    _this._player.onSquat();
                }
                if (e.keyCode == _this._keyAssign.left) {
                    _this._player.onLeft();
                }
                if (e.keyCode == _this._keyAssign.right) {
                    _this._player.onRight();
                }
                if (e.keyCode == _this._keyAssign.pause) {
                    _this._player.onPause();
                }
            });
            document.addEventListener('keyup', function (e) {
                if (e.keyCode == _this._keyAssign.a || e.keyCode == _this._keyAssign.x || e.keyCode == _this._keyAssign.y) {
                    _this._player.onAbortJump();
                }
                if (e.keyCode == _this._keyAssign.b) {
                    _this._player.onAbortSpeedUp();
                    _this._player.onAbortGrab();
                }
                if (e.keyCode == _this._keyAssign.up) {
                    _this._player.onAbortLookup();
                }
                if (e.keyCode == _this._keyAssign.down) {
                    _this._player.onAbortSquat();
                }
                if (e.keyCode == _this._keyAssign.left) {
                    _this._player.onAbortLeft();
                }
                if (e.keyCode == _this._keyAssign.right) {
                    _this._player.onAbortRight();
                }
            });
        };
        return KeyboardController;
    }());
    KeyboardController.DefaultKeyAssign = {
        left: 37,
        right: 39,
        up: 38,
        down: 40,
    ...
    Charjs.KeyboardController = KeyboardController;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var TouchController = (function () {
        ...
        TouchController.prototype.init = function (player) {
            this._player = player;
            return this;
        };
        TouchController.prototype.touch = function (touchLength) {
            switch (touchLength) {
                case 1:
                    this._player.onGrab();
                    break;
        ...
        TouchController.prototype.touchAbort = function (touchLength) {
            switch (touchLength) {
                case 3:
                    this._player.onAbortSquat();
                    break;
        ...
        TouchController.prototype.destroyCommand = function () {
        };
        TouchController.prototype.registerCommand = function () {
            var _this = this;
            ...
            window.addEventListener('deviceorientation', function (e) {
                ...
                switch (_this._screenModeForMobile) {
                    case 'PORTRAIT':
                        ...
                        break;
                    case 'LANSCAPE':
                        motionRun = Math.round(e.beta) * _this._deviceDirection;
                        motionUp = 90 - (Math.round(e.gamma) * _this._deviceDirection * -1);
                        break;
                }
                if (motionUp > 70) {
                    _this._player.onLookup();
                ...
                if (Math.abs(motionRun) >= 30 && _this._canSpeedUpForMobile) {
                    _this._canSpeedUpForMobile = false;
                    _this._player.onSpeedUp();
                }
                else if (Math.abs(motionRun) < 30 && !_this._canSpeedUpForMobile) {
                    _this._player.onAbortSpeedUp();
    ...
    Charjs.TouchController = TouchController;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var AbstractEffect = (function (_super) {
        __extends(AbstractEffect, _super);
        function AbstractEffect(targetDom, pixSize, zIndex, frameInterval) {
            if (pixSize === void 0) { pixSize = 2; }
            if (zIndex === void 0) { zIndex = 110; }
            if (frameInterval === void 0) { frameInterval = 45; }
            var _this = _super.call(this, targetDom, pixSize, undefined, undefined, false, false, zIndex) || this;
            _this.pixSize = pixSize;
            _this.zIndex = zIndex;
            _this.frameInterval = frameInterval;
            return _this;
        }
        AbstractEffect.prototype.onPushedUp = function (player) { };
        AbstractEffect.prototype.onStepped = function (player) { };
        return AbstractEffect;
    }(Charjs.AbstractObject));
    Charjs.AbstractEffect = AbstractEffect;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var PointEffect = (function (_super) {
        __extends(PointEffect, _super);
        function PointEffect() {
            ...
            _this.chars = null;
            _this.colors = ['', '#fff', '#000', '#f00'];
            return _this;
        }
        PointEffect.prototype.onPushedUp = function (player) { };
        PointEffect.prototype.onStepped = function (player) { };
        PointEffect.prototype.init = function () {
            _super.prototype.init.call(this);
            return this;
        };
        PointEffect.drawPoint = function (targetDom, pos, pointIndex, pixSize) {
        ...
        PointEffect.prototype.drawEffect = function (_pos, pointIndex) {
            var _this = this;
            if (pointIndex >= this.chars.length)
                pointIndex = this.chars.length - 1;
            var pos = JSON.parse(JSON.stringify(_pos));
            var count = 0;
            var effect = this.draw(pointIndex, pos, undefined, undefined, true, undefined, true);
            var tEffect = this.getTimer(function () {
                if (count < 8)
                    pos.y += 4 * _this.pixSize;
                else
                    pos.y += 1 * _this.pixSize;
                if (count >= 20) {
                    _this.removeCharacter(effect);
                    _this.destroy();
                    _this.removeTimer(tEffect);
                }
                else {
                    _this.move(effect, pos);
                    count++;
                }
            }, this.frameInterval * 2);
        };
        PointEffect.prototype.move = function (target, pos) {
            target.style.left = pos.x + 'px';
            target.style.bottom = pos.y + 'px';
        };
        return PointEffect;
    }(Charjs.AbstractEffect));
    PointEffect.staticEffect = null;
    Charjs.PointEffect = PointEffect;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var SlipEffect = (function (_super) {
        ...
        SlipEffect.drawSlip = function (targetDom, pos, pixSize) {
...
(function (Charjs) {
    var SpecialEffect = (function (_super) {
        ...
        SpecialEffect.drawSpecial = function (targetDom, pos, pixSize) {
            if (!SpecialEffect.staticEffect) {
                SpecialEffect.staticEffect = new SpecialEffect(targetDom, pixSize);
                SpecialEffect.staticEffect.init();
            }
            SpecialEffect.staticEffect.drawEffect(pos);
        };
    ...
    SpecialEffect.staticEffect = null;
...
(function (Charjs) {
    var StarEffect = (function (_super) {
        ...
        StarEffect.drawStar = function (targetDom, pos, pixSize) {
...
(function (Charjs) {
    var AbstractEnemy = (function (_super) {
        ...
        AbstractEnemy.prototype.onPushedUp = function (player) {
            var ePos = this.getPosition();
            var effectPos = { x: (this.position.x + ePos.x) / 2, y: (this.position.y + ePos.y) / 2 };
            Charjs.StarEffect.drawStar(this.targetDom, effectPos, this.pixSize);
            Charjs.PointEffect.drawPoint(this.targetDom, ePos, 0, this.pixSize);
            if (player) {
                player.addScore(0);
            }
            this.onEnemyAttack(Charjs.Direction.Right, 0);
        };
        AbstractEnemy.prototype.doHitTestWithOtherEnemy = function () {
            if (this._gameMaster) {
                var enemys = this._gameMaster.getEnemys();
                for (var name_11 in enemys) {
                    if (enemys[name_11] != this && enemys[name_11].isActive()) {
                        var ePos = enemys[name_11].getPosition();
                        var eSize = enemys[name_11].getCharSize();
...
(function (Charjs) {
    var GoombaWorld = (function (_super) {
            ...
            if (!this._grabbedPlayer) {
                ...
                if (targetEnemy) {
                    if (this._isKickBound) {
                        ...
                        Charjs.PointEffect.drawPoint(this.targetDom, targetEnemy.getPosition(), 0, this.pixSize);
                        if (this._kickPlayer)
                            this._kickPlayer.addScore(0);
                        this.onEnemyAttack(targetEnemyCenter <= enemyCenter ? Charjs.Direction.Right : Charjs.Direction.Left, 10);
                        Charjs.PointEffect.drawPoint(this.targetDom, this.position, 0, this.pixSize);
                        if (this._kickPlayer)
                            this._kickPlayer.addScore(0);
                        var effectPos = { x: (this.position.x + ePos.x) / 2, y: (this.position.y + ePos.y) / 2 };
                        Charjs.StarEffect.drawStar(this.targetDom, effectPos, this.pixSize);
        ...
        GoombaWorld.prototype.onKicked = function (kickDirection, kickPower, player) {
...
(function (Charjs) {
    var KoopaWorld = (function (_super) {
        ...
        KoopaWorld.prototype.drawAction = function () {
            ...
            if (this._xVector > 0) {
                Charjs.SlipEffect.drawSlip(this.targetDom, this.position, this.pixSize);
                action = 2;
            }
            else {
                if (this._currentStep < this._step) {
...
(function (Charjs) {
    var KoopatroopaWorld = (function (_super) {
        ...
        KoopatroopaWorld.prototype.onStepped = function (player, attackDirection) {
            if (this._gameMaster) {
                this._isActive = false;
...
(function (Charjs) {
    var TroopaWorld = (function (_super) {
        ...
        TroopaWorld.prototype.onAction = function () {
            if (!this._grabbedPlayer) {
                ...
                if (targetEnemy && this._speed > 0 && targetEnemy.isActive()) {
                    ...
                    var enemyCenter = this.position.x + this.size.width / 2;
                    targetEnemy.onEnemyAttack(targetEnemyCenter <= enemyCenter ? Charjs.Direction.Left : Charjs.Direction.Right, 10);
                    Charjs.PointEffect.drawPoint(this.targetDom, targetEnemy.getPosition(), this._point, this.pixSize);
        ...
        TroopaWorld.prototype.onKicked = function (kickDirection, kickPower, player) {
...
(function (Charjs) {
    var AbstractGround = (function (_super) {
        ...
        AbstractGround.prototype.onPushedUp = function (player) { };
        AbstractGround.prototype.onStepped = function (player) { };
        ...
        AbstractGround.prototype.createImage = function (map, reverse, vertical) {
            ...
            element.setAttribute("width", size.toString());
            element.setAttribute("height", size.toString());
            Charjs.AbstractCharacter.drawCharacter(ctx, map, this.colors, this.pixSize, reverse, vertical, false);
...
(function (Charjs) {
    var NormalBlockWorld = (function (_super) {
        ...
        NormalBlockWorld.prototype.isActive = function () {
            return this._isActive;
        };
        NormalBlockWorld.prototype.onPushedUp = function (player) {
        ...
        NormalBlockWorld.prototype.onStepped = function (player) { };
...
(function (Charjs) {
    var AbstractPlayer = (function (_super) {
        ...
        AbstractPlayer.prototype.setController = function (gameController) {
            this._gameController = gameController;
        };
        AbstractPlayer.prototype.getScore = function () {
            return this.score;
        };
        AbstractPlayer.prototype.addScore = function (pointIndex) {
            var point = 0;
            switch (pointIndex) {
                case 0:
                    point = 200;
...
var Charjs;
(function (Charjs) {
    var AbstractMarioWorld = (function (_super) {
        __extends(AbstractMarioWorld, _super);
        function AbstractMarioWorld(targetDom, pixSize, position, direction, zIndex, frameInterval) {
            if (direction === void 0) { direction = Charjs.Direction.Right; }
            if (zIndex === void 0) { zIndex = 100; }
            if (frameInterval === void 0) { frameInterval = 45; }
            var _this = _super.call(this, targetDom, pixSize, position, direction, true, false, zIndex, frameInterval) || this;
            _this._runIndex = 0;
            _this._currentStep = AbstractMarioWorld.STEP;
            _this._yVector = 0;
            _this._xVector = 0;
            _this._jumpPower = 18;
            _this._speed = 0;
        ...
        AbstractMarioWorld.prototype.onAction = function () {
            var _this = this;
            this.updateEntity();
        ...
        AbstractMarioWorld.prototype.checkGrabedEnemysAttack = function (enemy) {
        ...
        AbstractMarioWorld.prototype.onPoint = function (targetPos, noCountUp) {
            Charjs.PointEffect.drawPoint(this.targetDom, targetPos, this._continuousPoint, this.pixSize);
            if (noCountUp) {
                this.addScore(0);
            }
            else {
        ...
        AbstractMarioWorld.prototype.doHitTest = function () {
            if (this._gameMaster) {
                var enemys = this._gameMaster.getEnemys();
                for (var name_12 in enemys) {
                    if (enemys[name_12].isActive() && this._grabedEnemy != enemys[name_12]) {
                        var ePos = enemys[name_12].getPosition();
                        var eSize = enemys[name_12].getCharSize();
                        this.checkGrabedEnemysAttack(enemys[name_12]);
                        if (this.position.y > ePos.y + eSize.height)
                            continue;
                        if (ePos.y > this.position.y + this.size.height)
                            continue;
                        ...
                        if (ePos.x > this.position.x + this.size.width)
                            continue;
                        if (enemys[name_12].isStepped()) {
                            if (!this._grabbing) {
                                if (this._isSpecial) {
                                    Charjs.SpecialEffect.drawSpecial(this.targetDom, enemys[name_12].getPosition(), this.pixSize);
                                    this.onPoint(enemys[name_12].getPosition());
                                    enemys[name_12].onKilled();
                                    ...
                                    return enemys[name_12].onKicked(this._attackDirection, this._speed * 3, this);
                                }
                            }
                            else {
                                this.grabEnemy(enemys[name_12]);
                        ...
                        if (this._isJumping && this._yVector < 0) {
                            if (this._isSpecial) {
                                Charjs.SpecialEffect.drawSpecial(this.targetDom, enemys[name_12].getPosition(), this.pixSize);
                                this.onPoint(enemys[name_12].getPosition(), true);
                                enemys[name_12].onKilled();
                                this._yVector = 2 * this.pixSize;
                            }
                            else {
                                ...
                                var enemyCenter = ePos.x + eSize.width / 2;
                                this._attackDirection = playerCenter <= enemyCenter ? Charjs.Direction.Right : Charjs.Direction.Left;
                                enemys[name_12].onStepped(this, this._attackDirection);
                                this.onPoint(ePos);
                                var effectPos = { x: (this.position.x + ePos.x) / 2, y: (this.position.y + ePos.y) / 2 };
                                Charjs.StarEffect.drawStar(this.targetDom, effectPos, this.pixSize);
        ...
        AbstractMarioWorld.prototype.executeJump = function () {
            var ground = this.entity.ground || 0;
            if (this.position.y > ground)
        ...
        AbstractMarioWorld.prototype.moveGrabedEnemy = function () {
            if (this._grabedEnemy) {
        ...
        AbstractMarioWorld.prototype.executeRun = function () {
            ...
            if (this._grabedEnemy) {
                ...
                if (!this._isJumping && this._isBraking) {
                    ...
                    Charjs.SlipEffect.drawSlip(this.targetDom, { x: this.position.x + (direction == Charjs.Direction.Left ? this.size.width : 0), y: this.position.y }, this.pixSize);
                }
            }
            if (this._isSquat) {
                if (this._grabedEnemy)
        ...
        AbstractMarioWorld.prototype.grabEnemy = function (enemy) {
            enemy.onGrabed(this);
            this._grabedEnemy = enemy;
        };
        AbstractMarioWorld.prototype.releaseEnemy = function () {
            this._grabedEnemy = null;
        };
        AbstractMarioWorld.prototype.putEnemy = function () {
        };
        AbstractMarioWorld.prototype.onPushedUp = function (player) {
            this._yVector += 10;
        };
        AbstractMarioWorld.prototype.onStepped = function (player) {
            this._yVector = 0;
        };
        AbstractMarioWorld.prototype.onGrab = function () {
            if (!this._isJumping && !this._isSquat) {
                this._grabbing = true;
            }
        };
        AbstractMarioWorld.prototype.onAbortGrab = function () {
            var _this = this;
        ...
        AbstractMarioWorld.prototype.onJump = function () {
            if (!this._isJumping && !this._isSquat) {
                this._isJumping = true;
        ...
        AbstractMarioWorld.prototype.onSpecialJump = function () {
            if (!this._isJumping && !this._isSquat) {
                this._isJumping = true;
        ...
        AbstractMarioWorld.prototype.onAbortJump = function () {
            if (this._yVector > 0) {
                this._yVector = 0;
            }
        };
        AbstractMarioWorld.prototype.onSpeedUp = function () {
            this._isSpeedUp = true;
        };
        AbstractMarioWorld.prototype.onAbortSpeedUp = function () {
            this._isSpeedUp = false;
        };
        AbstractMarioWorld.prototype.onLookup = function () {
            if (!this._isJumping && !this._isLeft && !this._isRight && !this._isSquat) {
                this._isLookup = true;
            }
        };
        AbstractMarioWorld.prototype.onAbortLookup = function () {
            this._isLookup = false;
        };
        AbstractMarioWorld.prototype.onSquat = function () {
            if (!this._isJumping && !this._isLookup) {
                this._isSquat = true;
            }
        };
        AbstractMarioWorld.prototype.onAbortSquat = function () {
            this._isSquat = false;
        };
        AbstractMarioWorld.prototype.onRight = function () {
            if (!this._isSquat) {
        ...
        AbstractMarioWorld.prototype.onAbortRight = function () {
            this._rightPushed = false;
            this._isRight = false;
            if (this._leftPushed)
                this._isLeft = true;
        };
        AbstractMarioWorld.prototype.onLeft = function () {
            if (!this._isSquat) {
        ...
        AbstractMarioWorld.prototype.onAbortLeft = function () {
            this._leftPushed = false;
            this._isLeft = false;
            if (this._rightPushed)
                this._isRight = true;
        };
        AbstractMarioWorld.prototype.onPause = function () {
            if (this._gameMaster) {
        ...
        AbstractMarioWorld.prototype.isSquat = function () {
            return this._isSquat;
        };
        AbstractMarioWorld.prototype.isJumping = function () {
            return this._isJumping;
        };
        AbstractMarioWorld.prototype.gameOver = function () {
            var _this = this;
            if (this._gameMaster)
                this._gameMaster.doGameOver(this);
            if (this._gameController)
                this._gameController.destroyCommand();
            this.stop();
            this._gameOverTimer = this.getTimer(function () {
                ...
                if (_this._currentStep < AbstractMarioWorld.STEP) {
                    _this._currentStep++;
                }
                else {
                    _this._currentStep = 0;
        ...
        AbstractMarioWorld.prototype.onGool = function (callback) {
            this.draw(10, null, Charjs.Direction.Right, Charjs.Vertical.Up, true);
            if (callback)
                callback();
        };
        AbstractMarioWorld.prototype.registerActionCommand = function () {
        };
        return AbstractMarioWorld;
    }(Charjs.AbstractPlayer));
    AbstractMarioWorld.STEP = 2;
    AbstractMarioWorld.DEFAULT_SPEED = 2;
    Charjs.AbstractMarioWorld = AbstractMarioWorld;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var LuigiWorld = (function (_super) {
        __extends(LuigiWorld, _super);
        function LuigiWorld() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.colors = [
                '',
        ...
        return LuigiWorld;
    }(Charjs.AbstractMarioWorld));
    Charjs.LuigiWorld = LuigiWorld;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
...
(function (Charjs) {
    var PlayerProxy = (function () {
        function PlayerProxy(_player, _peerClinet) {
            var _this = this;
            this._player = _player;
            this._peerClinet = _peerClinet;
        ...
        PlayerProxy.prototype.setController = function (gameController) {
            var _this = this;
            this._gameController = gameController;
            this._timer = setInterval(function () {
                if (_this._buttonUpdated) {
                    _this._peerClinet.send(_this._player._name, _this._butttonState);
                    _this._buttonUpdated = false;
                    _this._butttonState.pause = false;
                }
            }, 20);
        };
        PlayerProxy.prototype.sendButtonState = function () {
            this._buttonUpdated = true;
        };
        PlayerProxy.prototype.onJump = function () {
        ...
        PlayerProxy.prototype.onSpecialJump = function () {
        ...
        PlayerProxy.prototype.onAbortJump = function () {
        ...
        PlayerProxy.prototype.onSpeedUp = function () {
        ...
        PlayerProxy.prototype.onAbortSpeedUp = function () {
            if (this._butttonState.b) {
        ...
        PlayerProxy.prototype.onLookup = function () {
        ...
        PlayerProxy.prototype.onAbortLookup = function () {
            if (this._butttonState.up) {
        ...
        PlayerProxy.prototype.onSquat = function () {
        ...
        PlayerProxy.prototype.onAbortSquat = function () {
            if (this._butttonState.down) {
        ...
        PlayerProxy.prototype.onLeft = function () {
        ...
        PlayerProxy.prototype.onAbortLeft = function () {
            if (this._butttonState.left) {
        ...
        PlayerProxy.prototype.onRight = function () {
        ...
        PlayerProxy.prototype.onAbortRight = function () {
            if (this._butttonState.right) {
        ...
        PlayerProxy.prototype.onPause = function () {
            this._butttonState.pause = true;
            this.sendButtonState();
            this._player.onPause();
        };
        PlayerProxy.prototype.onGrab = function () {
            this._player.onGrab();
        };
        PlayerProxy.prototype.onAbortGrab = function () {
            this._player.onAbortGrab();
        };
        return PlayerProxy;
    }());
    Charjs.PlayerProxy = PlayerProxy;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var GameClient = (function (_super) {
        ...
        function GameClient() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this._hostInitDoneDefer = MyQ.Deferred.defer();
            _this._hostInitDone = function (command) {
                _this._hostInitDoneDefer.resolve({});
            };
            _this._init = function (command) {
                _super.prototype.init.call(_this);
            };
            _this._start = function (command) {
                _super.prototype.start.call(_this);
            };
            _this.createRemotePlayer = function (command) {
                var args = [];
                args.push(Charjs.ClassUtil.getClass(command.target, Charjs));
                var master = GameClient.GetController(_this._peerId);
                var player = master.CreatePlayerInstance.apply(_this, args.concat(command.data));
                var controller = new Charjs.PlayerProxy(player, _this._peer);
                _this._peer.setReciveCallback(player._name, controller.onCommand);
            };
            _this.createRemoteEnemy = function (command) {
                var args = [];
                args.push(Charjs.ClassUtil.getClass(command.target, Charjs));
                var master = GameClient.GetController(_this._peerId);
                master.CreateEnemyInstance.apply(_this, args.concat(command.data));
            };
            _this.createRemoteObject = function (command) {
                var args = [];
                args.push(Charjs.ClassUtil.getClass(command.target, Charjs));
                var master = GameClient.GetController(_this._peerId);
                master.CreateObjectInstance.apply(_this, args.concat(command.data));
            };
            return _this;
        }
        ...
        GameClient.prototype.connectToRemoteHost = function (peerId) {
            var _this = this;
            GameClient.GAME_MASTERS[peerId] = this;
            this.setPeerId(peerId);
            this.createPeer().connect(this._peerId).then(function () {
                _this._peer.send(Charjs.AbstractGamePeer.CONNECTED_COMMAND, []);
            });
            return this._hostInitDoneDefer.promise;
        };
        GameClient.prototype.registerEvent = function () {
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.HOST_INIT_DONE_COMMAND, this._hostInitDone);
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.INIT_COMMAND, this._init);
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.START_COMMAND, this._start);
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.CREATE_PLAYER_COMMAND, this.createRemotePlayer);
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.CREATE_ENEMY_COMMAND, this.createRemoteEnemy);
            this._peer.setReciveCallback(Charjs.AbstractGamePeer.CREATE_OBJECT_COMMAND, this.createRemoteObject);
        };
        GameClient.prototype.initDone = function () {
            this._peer.send(Charjs.AbstractGamePeer.CLIENT_INIT_DONE_COMMAND, []);
        };
        GameClient.prototype.CreatePlayerInstanceWithRemote = function (clz, position, direction, name) {
            if (direction === void 0) { direction = Charjs.Direction.Right; }
            ...
            this._peer.send(Charjs.GameHost.CREATE_PLAYER_COMMAND, command);
            return _super.prototype.CreatePlayerInstance.call(this, clz, position, direction, name);
        };
        return GameClient;
    ...
    var GameHost = (function (_super) {
        ...
        function GameHost() {
            ...
            _this.create2ndPlayer = function (command) {
                var args = [];
                args.push(Charjs.ClassUtil.getClass(command.target, Charjs));
                var master = GameHost.GetController(_this._peerId);
                var player = master.CreatePlayerInstance.apply(_this, args.concat(command.data));
                var controller = new Charjs.PlayerProxy(player, _this._peer);
                _this._peer.setReciveCallback(player._name, controller.onCommand);
            };
        ...
        GameHost.prototype.openHost = function () {
            ...
            peer.setReciveCallback(Charjs.AbstractGamePeer.CREATE_PLAYER_COMMAND, this.create2ndPlayer);
            return d.promise;
        };
        GameHost.prototype.initDone = function () {
            this._peer.send(Charjs.AbstractGamePeer.HOST_INIT_DONE_COMMAND, []);
        };
        GameHost.prototype.gameStart = function () {
            var _this = this;
            this.clinetInit().then(function () {
                _this._init();
                _this._start();
            });
        };
        GameHost.prototype._init = function () {
            this._peer.send(GameHost.INIT_COMMAND, {});
            _super.prototype.init.call(this);
        };
        GameHost.prototype._start = function () {
            this._peer.send(GameHost.START_COMMAND, {});
            _super.prototype.start.call(this);
        };
        GameHost.prototype.onClientConnected = function () {
            return this._initDefer.promise;
        };
        GameHost.prototype.clinetInit = function () {
            return this._clientInitDoneDefer.promise;
        };
        GameHost.prototype.CreatePlayerInstanceWithRemote = function (clz, position, direction, name) {
            if (direction === void 0) { direction = Charjs.Direction.Right; }
            name = name || RandomGenerator.generateUUIDv4();
            var command = {
                target: clz.name,
        ...
        GameHost.prototype.CreateEnemyInstanceWithRemote = function (clz, position, direction) {
            if (direction === void 0) { direction = Charjs.Direction.Right; }
            var command = {
                target: clz.name,
            ...
            return _super.prototype.CreateEnemyInstance.call(this, clz, position, direction);
        };
        GameHost.prototype.CreateObjectInstanceWithRemote = function (clz, position) {
            var command = {
                target: clz.name,
                data: [position]
            };
            this._peer.send(GameHost.CREATE_OBJECT_COMMAND, command);
            return _super.prototype.CreateObjectInstance.call(this, clz, position);
        };
        return GameHost;
    }(Charjs.AbstractGamePeer));
...
(function (Charjs) {
    var ClassUtil = (function () {
        ...
        ClassUtil.getClass = function (className, nameSpace) {
            var p = className.split(".");
            var c = nameSpace || window;
            if (p.length >= 0) {
        ...
        ClassUtil.isClass = function (obj, className) {
            var cnl = className.split(".");
...
(function (Charjs) {
    ...
    Charjs.GameUtil = GameUtil;
})(Charjs || (Charjs = {}));
var Charjs;
(function (Charjs) {
    var PeerConnector = (function () {
        function PeerConnector(apiKey) {
            if (apiKey === void 0) { apiKey = PeerConnector.API_KEY; }
            this.apiKey = apiKey;
            this._peer = null;
            ...
            this._peerEvent = {};
            this._peerInitialized = false;
        }
        PeerConnector.getPeer = function (apiKey) {
        ...
        PeerConnector.prototype.connect = function (peerId) {
            var _this = this;
            var d = MyQ.Deferred.defer();
            if (!this._isOpened && !this._isConnected) {
                this._peer = new Peer({ key: this.apiKey });
    ...
    PeerConnector.API_KEY = 'fikef0tx5c3j714i';
    PeerConnector.staticPeer = null;
    Charjs.PeerConnector = PeerConnector;
})(Charjs || (Charjs = {}));
var MyQ;
(function (MyQ) {
    var Promise = (function () {
        ...
        Promise.all = function (promises) {
            ...
            var callbackCount = 0;
            var promisesArgs = [];
            var allPromise = MyQ.Deferred.defer();
        ...
        Promise.race = function (promises) {
            var racePromise = MyQ.Deferred.defer();
        ...
        Promise.reduce = function (values, func) {
            ...
            }, Promise.when()).then(function (lastValue) {
                d.resolve(lastValue);
            });
            return d.promise;
        };
...
var RandomGenerator = (function () {
    ...
    RandomGenerator.getRandom = function (max, min) {
        if (min === void 0) { min = 0; }
        return Math.floor(Math.random() * (max + 1 - min)) + min;
    };
    RandomGenerator.getNormdistRandom = function (max, min, normdist) {
        if (min === void 0) { min = 0; }
    ...
    RandomGenerator.generateUUIDv4 = function () {
